...
class Magegiant_Fullpagecache_Block_Adminhtml_Cache_Blockhtml_Config_Grid extends Magegiant_Fullpagecache_Block_Adminhtml_Cache_Common_Grid
{
    ...
    {
        $collection = Mage::getModel('fullpagecache/cache_blockhtml_config')->getCollection();
