...
class Magegiant_Fullpagecache_Main
{
    ...
    {
        $instanceName = $class;
        $rewrites = Magegiant_Fullpagecache_Helper_Data::getSimpleConfig()->getNode('global/fullpagecache/rewrites');
    ...
    {
        Mage::register('is_in_fullpagecache_render_page_area', true);
    ...
    {
        Magegiant_Fullpagecache_Model_Cache_Fullpage_Renderer_Factory::getInstance()->buildRenderer()->renderPage();
        Mage::unregister('is_in_fullpagecache_render_page_area');
    }

    protected function _loadObservers()
    {
        $events = Magegiant_Fullpagecache_Helper_Data::getSimpleConfig()->getNode('global/fullpagecache/events');
