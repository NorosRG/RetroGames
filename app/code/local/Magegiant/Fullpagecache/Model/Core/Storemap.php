...
class Magegiant_Fullpagecache_Model_Core_Storemap
{
    const FULLPAGECACHE_STOREMAP = 'fullpagecache_storemap';
    ...
    {
        $this->_cache = ($useCacheContainer) ? Magegiant_Fullpagecache_Helper_Data::getCacheContainer()->getCache() : Mage::app()->getCache();
        $this->_useTwoLevels = ($useCacheContainer) ? Magegiant_Fullpagecache_Helper_Data::getCacheContainer()->getUseTwoLevels() : false;
    }

    protected function _getCacheKey()
    {
        return Magegiant_Fullpagecache_Helper_Data::formatCacheKey(self::FULLPAGECACHE_STOREMAP);
    }
    ...
    {
        return unserialize(Magegiant_Fullpagecache_Helper_Data::loadFromCache($this->_getCacheKey(), $this->_cache, $this->_useTwoLevels));
    }
