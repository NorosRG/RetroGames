...
class Magegiant_Fullpagecache_Model_Optimization_Url extends Mage_Catalog_Model_Url
{
    /**
     * Retrieve resource model
     *
     * @return Magegiant_Fullpagecache_Model_Mysql4_Optimization_Indexer_Url
     */
    public function getResource()
    {
        if (is_null($this->_resourceModel)) {
            $this->_resourceModel = Mage::getResourceModel('fullpagecache/optimization_indexer_url');
        }
    ...
    public function refreshProductRewrites($storeId)
    {
        ...
        $enableOptimisation = Mage::getStoreConfigFlag('fullpagecache/optimization_index_url/enable');
        $excludeProductsDisabled = Mage::getStoreConfigFlag('fullpagecache/optimization_index_url/disable');
        $excludeProductsNotVisible = Mage::getStoreConfigFlag('fullpagecache/optimization_index_url/notvisible');
