...
class Magegiant_Fullpagecache_Adminhtml_Catalog_CleanerController extends Magegiant_Fullpagecache_Controller_Adminhtml_Action
{
    public function massCleanProductCacheAction()
    {
        ...
        Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('fullpagecache')->__('Cache successfully cleaned'));
